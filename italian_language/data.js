...
// 2-1. 품사란? + 한국어·이탈리아어·영어·라틴어 품사 비교
// (라틴어는 이탈리아어를 비롯한 로망스어파 언어들의 뿌리가 되는 언어예요)
const posIntro = "품사(品詞)란 단어를 문법적 기능과 성질에 따라 나눈 갈래예요. 명사, 동사, 형용사처럼 '단어의 종류'를 가리키는 말이죠. 이탈리아어는 라틴어에서 갈라져 나온 로망스어파 언어라서, 라틴어의 복잡한 격변화 체계가 단순해지면서 오늘날 이탈리아어 문법의 모습이 되었어요. 그래서 이탈리아어 품사를 라틴어와 비교해보면 '왜 이렇게 변화하는지' 뿌리를 이해할 수 있어요.";

const posCompare = [
  {
    pos: "명사 (Noun)",
    ko: "성(性) 구분이 없어요. 조사(을/를, 이/가)를 붙여 문장 속 역할을 표시해요.",
    it: "명사가 남성·여성 2성으로 나뉘고 단·복수가 있어요. 관사가 성·수에 맞춰 함께 변해요.",
    en: "성 구분이 없어요. 단·복수만 구분해요 (book → books).",
    la: "남성·여성·중성 3성에 6格(주격·속격·여격·대격·탈격·호격)까지 어미가 변화해요."
  },
  {
    pos: "동사 (Verb)",
    ko: "어간에 어미를 바꿔 붙여 시제·높임·양태를 표현해요. 인칭에 따른 변화는 없어요.",
    it: "주어 인칭(6가지)에 따라 어미가 달라져요(활용, coniugazione). -are/-ere/-ire 세 그룹으로 나뉘어요.",
    en: "인칭 변화가 거의 없어요(3인칭 단수 -s 정도). 시제는 will/have 같은 조동사로 표현해요.",
    la: "인칭·시제·법(직설법/접속법)·태(능동/수동)에 따라 매우 세밀하게 활용돼요. 이탈리아어 동사 활용의 원형이에요."
  },
  {
    pos: "형용사 (Adjective)",
    ko: "형태 변화 없이 명사 앞에 와요.",
    it: "꾸미는 명사의 성·수에 맞춰 어미가 변하고, 대개 명사 뒤에 위치해요.",
    en: "형태 변화 없이 명사 앞에 와요.",
    la: "명사의 성·수·격에 모두 일치하도록 변화해요. 어순은 비교적 자유로워요."
  },
  {
    pos: "관사 (Article)",
    ko: "관사가 없어요.",
    it: "정관사(il/lo/la/i/gli/le), 부정관사(un/uno/una)가 성·수·뒤에 오는 소리에 따라 세분화돼요.",
    en: "부정관사 a/an, 정관사 the로 비교적 단순해요.",
    la: "관사가 아예 없어요! 명사·형용사 자체의 어미 변화만으로 성·수·격을 표현하기 때문이에요."
  },
  {
    pos: "대명사 (Pronoun)",
    ko: "자주 생략되고, 높임말(저/나, 당신/너)로 격식을 구분해요.",
    it: "인칭대명사(io, tu...)는 동사 활용만으로 알 수 있어 자주 생략돼요. 반말(tu)/존댓말(Lei) 구분이 있어요.",
    en: "인칭대명사에 격변화 흔적이 남아 있어요 (I - my - me).",
    la: "명사처럼 6格 변화를 하고, 성·수까지 구분해요."
  },
  {
    pos: "전치사 (Preposition)",
    ko: "전치사 대신 조사(에, 에서, 로)를 명사 뒤에 붙여요 (후치사적 성격).",
    it: "전치사가 발달했어요 (a, di, da, in, con, su, per...), 명사 앞에 위치해요.",
    en: "전치사가 발달했어요 (in, on, at, to...), 명사 앞에 위치해요.",
    la: "전치사가 있지만, 격변화만으로도 의미가 통해서 의존도가 상대적으로 낮아요."
  },
  {
    pos: "부사 (Adverb)",
    ko: "동사·형용사를 꾸미며 형태 변화가 없어요.",
    it: "형용사에 -mente를 붙여 만드는 경우가 많아요 (lento→lentamente, 느린→느리게).",
    en: "형용사에 -ly를 붙여 만드는 경우가 많아요 (slow→slowly).",
    la: "형태가 다양하고 불규칙적이지만, 격변화는 하지 않아요."
  },
  {
    pos: "접속사 (Conjunction)",
    ko: "어미(-고, -지만)나 별도 단어(그리고, 그러나)로 표현해요.",
    it: "e(그리고), ma(그러나), o(또는)처럼 독립된 단어로 존재해요.",
    en: "and, but, or처럼 독립된 단어로 존재해요.",
    la: "et, sed, aut처럼 독립된 단어로 존재해요. 이탈리아어 e/ma/o의 어원이 되기도 해요."
  },
  {
    pos: "감탄사 (Interjection)",
    ko: "아!, 어머!, 와! 처럼 형태 변화 없이 감정을 표현해요.",
    it: "Ah!, Oh!, Ecco!(자, 여기)처럼 사용돼요.",
    en: "Oh!, Wow!, Ouch!처럼 사용돼요.",
    la: "Eheu!(아이고!), Ecce!(보라!)처럼 사용돼요."
  }
];

// 2-2. 품사 용어 사전 (품사 이름 자체에 마우스를 올리면 뜻을 보여주기 위한 사전)
const termGlossary = {
  "명사":   "사람, 사물, 장소, 개념 등의 이름을 나타내는 품사예요. 문장에서 주어·목적어 등으로 쓰여요.",
  "동사":   "사람이나 사물의 동작, 상태, 존재를 나타내는 품사예요. 문장의 서술어 역할을 해요.",
  "형용사": "사람이나 사물의 성질·상태를 꾸며주는 품사예요. 명사를 수식하거나 서술해요.",
  "부사":   "동사·형용사·다른 부사나 문장 전체를 꾸며 '어떻게, 언제, 얼마나'를 나타내는 품사예요.",
  "대명사": "명사를 대신해서 가리키는 품사예요. 예: 나, 너, 그것.",
  "부정관사": "특정하지 않은, 처음 언급되는 대상을 가리킬 때 쓰는 관사예요. 예: 영어의 a/an, 이탈리아어의 un/uno/una.",
  "정관사": "이미 알고 있거나 특정하게 정해진 대상을 가리킬 때 쓰는 관사예요. 예: 영어의 the, 이탈리아어의 il/lo/la/i/gli/le.",
  "관사":   "명사 앞에 붙어서 그 명사가 특정한 것인지 아닌지, 하나인지 여럿인지를 나타내는 품사예요. 한국어에는 없어요.",
  "전치사": "명사·대명사 앞에 놓여 장소·시간·방향 등의 관계를 나타내는 품사예요.",
  "접속사": "단어와 단어, 문장과 문장을 이어주는 품사예요.",
  "감탄사": "놀람, 기쁨, 슬픔 같은 감정을 표현하는 독립적인 품사예요."
};
...
const glossary = {
  ...
  "lo":       { ko: "그 (남성 단수, 특정 발음 앞)", pos: "관사" },
  "le":       { ko: "그 (여성 복수)", pos: "관사" },
